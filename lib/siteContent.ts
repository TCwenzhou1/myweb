...
export const projectCases: ProjectCase[] = [
  ...
  },
  {
    ...
    description:
      '这是一个面向 AI 工作流和组织协作的产品原型。它不只展示 3D 办公室，而是把一个小型工程团队的拆解、执行、联调、巡检和追责机制做成可以在网页里运行的大模型编排控制台。',
    tags: ['Next.js', 'OpenAI API', 'Multi-agent', 'Workflow', 'Three.js'],
    status: 'active',
    year: '2026',
    period: '2026',
    ...
    architecture: [
      ...
      '原有 3D 办公室 demo 继续作为沉浸式入口，新的控制台负责证明流程和模型有效性',
    ],
    challenges: [
